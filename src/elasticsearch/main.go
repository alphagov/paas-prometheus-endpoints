...
func main() {
	...
	cfg := NewCustomConfigFromEnv("elasticsearch")
	...
	metricFetcher := NewElasticsearchMetricFetcher(
		cfg.AivenProjectName,
		cfg.AivenPrometheusUsername,
		cfg.AivenPrometheusPassword,
		cfg.Logger,
	)
